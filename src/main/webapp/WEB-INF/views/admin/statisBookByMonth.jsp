							...
							<div class="widget-header">
								...
								<div class="widget-toolbar no-border">
									<ul class="nav nav-tabs" id="recent-tab">
										<li><a  href="/admin/statisBook">Theo
												Ngày</a></li>

										<li  class="active"><a  href="/admin/statisBookMonth">Theo
												Tháng</a></li>

										<li><a  href="/admin/statisBookYear">Theo Năm</a>
										</li>
									</ul>
								</div>
							</div>
												...
												<div class="col-xs-12">
													...
													<form class="form-search">
														<div class="row">
															<div class="col-xs-12 col-sm-8">
																<form action="/admin/statisBookMonth" method="post">
																	<div class="input-group">
																		<span class="input-group-addon"> <i
																			class="ace-icon fa fa-check"></i>
																		</span> <input type="text" value="${sessionScope.keyword}"
													...
													<div>
														<table id="dynamic-table"
															...
															<tbody>
															<c:forEach var="item" items="${statisMonthItem.content}">
																	<tr>
																		<td class="center">${locationMonth=locationMonth+1}</td>
																		...
																		<div style="display:none;">${totalMonth=totalMonth+item.count}</div>
																	</tr>
																</c:forEach>
																	<tr>
																		...
																		<td class="hidden-480">${totalMonth}</td>
																		<td></td>
																		<td></td>
													...
													<div class="modal-footer no-margin-top center">
														...
														<ul class="pagination justify-content-center">
															<li
																class="page-item ${(statisMonthItem.number==0)?'disabled':''}"><a
																class="page-link"
																href="/admin/statisBookMonth?p=${statisMonthItem.number-1}"
																aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
															</a></li>
															<li class="page-item disabled"><a class="page-link"
																href="#">${statisMonthItem.number+1}</a></li>
															<li
																class="page-item ${(statisMonthItem.number>=statisMonthItem.totalPages-1)?'disabled':''}"><a
																class="page-link"
																href="/admin/statisBookMonth/list?p=${statisMonthItem.number+1}"
