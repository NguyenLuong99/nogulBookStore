						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-4 mb-3">
									<form action="/sale/authorTable/list" method="post">
										<div class="input-group">
											<input type="text" name="keyword"
												value="${sessionScope.keyword}" class="form-control"
												placeholder="Tìm theo tên" onchange="/sale/authorTable/list">
								...
								<tbody>
									<c:forEach var="item" items="${userItem.content}">
										<tr>
											...
											<td>${item.des}</td>
											<td>${item.numberOfbook}</td>
											<td>
												<a href="/sale/authorTable/list/load/${item.id}" class="btn btn-success">Sửa</a> 
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="/sale/authorTable/list/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(userItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/sale/authorTable/list?p=${userItem.number-1}"
