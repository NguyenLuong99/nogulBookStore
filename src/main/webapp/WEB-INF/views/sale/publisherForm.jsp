...
<body id="page-top">
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Form Nhà Xuất bản</h1>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form action="/sale/publisherForm/form" method="post"
								modelAttribute="publisherForm" enctype="multipart/form-data">
								<div class="form-group">
									<label for="inputEmail4">Tên Nhà Xuất Bản</label>
								...
								<c:if test="${edit2}">
									<button
										formaction="/sale/publisherForm/form/edit/${sessionScope.id2 }"
										class="btn btn-primary">
										<i class="fas fa-pen"></i> Cập nhật
									</button>
								</c:if>

								<button formaction="/sale/publisherForm/refresh"
									class="btn btn-info">
									<i class="fas fa-redo-alt"></i> Làm mới
								</button>
									<button formaction="/sale/publisherTable/list" formmethod="get"
