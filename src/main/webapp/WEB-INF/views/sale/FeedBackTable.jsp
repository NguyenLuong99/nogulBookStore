...
<head>
<meta charset="UTF-8">
<title>Page Sale - FeedBack Table</title>
</head>
<body >
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-8 ">
						<!--			<a href="/sale/authorTable/form" class="btn btn-primary"> <i
										class="fas fa-plus-square"></i> Thêm mới
									</a> -->
								</div>
								<div class="col-lg-4 mb-3">
									<form action="/sale/feedBackTable/list" method="post">
										<div class="input-group">
											<input type="text" name="keyword"
												value="${sessionScope.keyword}" class="form-control"
												placeholder="Tìm theo tên" onchange="/sale/feedBackTable/list">
							...
							<table class="table table-bordered" width="100%" cellspacing="0">
								...
								<tbody>
									<c:forEach var="item" items="${userItem.content}">
										<tr>
											<td>${item.group.book.name}</td>
											<td> ${item.firstname} ${item.lastname }</td>
											<td>${item.group.content}</td>
											<td>${item.group.thumbnail}</td>
											<td>
												<a href="/sale/authorTable/list/load/${item.group.id}" class="btn btn-success">Trả lời</a> 
												<a href="/sale/authorTable/list/load/${item.group.id}" class="btn btn-success">Ghim</a> 
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="/sale/feedBackTable/list/delete/${item.group.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(userItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/sale/feedBackTable/list?p=${userItem.number-1}"
