							...
							<div class="widget-header">
								...
								<div class="widget-toolbar no-border">
									<ul class="nav nav-tabs" id="recent-tab">
										...
										<li><a  href="/admin/statisBookMonth">Theo
												Tháng</a></li>

										<li class="active"><a 
											href="/admin/statisBookYear">Theo Năm</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="widget-body">
								<div class="widget-main padding-4">
									<div class="tab-content padding-8">
										<div id="task-tab" class="tab-pane"></div>
										<!-- Tháng -->
												...
												<div class="col-xs-12">
													...
													<form class="form-search">
														<div class="row">
															<div class="col-xs-12 col-sm-8">
																<form action="/admin/statisBookYear" method="post">
													...
													<div>
														<table id="dynamic-table"
															...
															<tbody>
																<c:forEach var="item" items="${statisYearItem.content}">
																	<tr>
																		<td class="center">${locationYear=locationYear+1}</td>
																		...
																		<div style="display:none;">${totalYear=totalYear+item.count}</div>
																	</tr>
																</c:forEach>
																	<tr>
																		...
																		<td class="hidden-480">${totalYear}</td>
																		<td></td>
																		<td></td>
													...
													<div class="modal-footer no-margin-top center">
														...
														<ul class="pagination justify-content-center">
															<li
																class="page-item ${(statisYearItem.number==0)?'disabled':''}"><a
																class="page-link"
																href="/admin/statisBookYear?p=${statisYearItem.number-1}"
																aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
															</a></li>
															<li class="page-item disabled"><a class="page-link"
																href="#">${statisYearItem.number+1}</a></li>
															<li
																class="page-item ${(statisYearItem.number>=statisYearItem.totalPages-1)?'disabled':''}"><a
																class="page-link"
																href="/admin/statisBookYear?p=${statisYearItem.number+1}"
