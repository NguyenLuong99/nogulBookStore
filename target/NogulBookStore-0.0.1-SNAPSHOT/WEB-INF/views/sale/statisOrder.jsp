...
<head>
<meta charset="UTF-8">
<title>Page Sale - thống kê đơn hàng</title>
<link
								...
								<div class="col-lg-4 mb-3">
									<form action="/admin/statis/order" method="post">
										<div class="input-group">
											<input type="text" name="keyword14"
												value="${sessionScope.keyword14}" class="form-control"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(statisOrder.number==0)?'disabled':''}"><a
										class="page-link"
										href="/sale/statis/order?p=${statisOrder.number-1}"
									...
									<li
										...
										class="page-link"
										href="/sale/statis/order?p=${statisFavorite.number+1}"
