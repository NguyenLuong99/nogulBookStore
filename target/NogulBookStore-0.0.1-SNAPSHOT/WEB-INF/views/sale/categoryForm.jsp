...
<head>
<meta charset="UTF-8">
<title>Page Admin - Danh mục</title>
</head>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Form Thể loại</h1>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form action="/sale/categoryForm/form" method="post"
								...
								<div class="form-group d-flex justify-content-center">
									<img src="/template/sale/img/${sessionScope.nameImage}"
								...
								<c:if test="${edit}">
									<button
										formaction="/sale/categoryForm/form/edit/${sessionScope.id}"
										class="btn btn-primary">
										<i class="fas fa-pen"></i> Cập nhật
									</button>
								</c:if>

								<button formaction="/sale/userForm/refresh"
									class="btn btn-info">
									<i class="fas fa-redo-alt"></i> Làm mới
								</button>
								<button formaction="/sale/categoryTable/list" formmethod="get"
