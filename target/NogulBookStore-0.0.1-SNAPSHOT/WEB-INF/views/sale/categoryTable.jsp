				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-8 ">
									<a href="/sale/categoryForm/form" class="btn btn-primary"> <i
										class="fas fa-plus-square"></i> Thêm mới
									</a>
								</div>
								<div class="col-lg-4 mb-3">
									<form action="/sale/categoryTable/list" method="post">
										<div class="input-group">
											<input type="text" name="keyword3"
												value="${sessionScope.keyword3}" class="form-control"
									...
									<c:forEach var="item" items="${userItem.content}">
										<tr>
											...
											<td class="text-center"><img width="100" height="100"
												src="/template/sale/img/${item.code}"></td>
											<td>
												<a href="/sale/categoryForm/list/load/${item.id}" class="btn btn-success">Sửa</a>
										...
										<div class="modal fade" id="exampleModal${item.id}"
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">Danh mục có tên là
														${item.name} sẽ bị xóa vĩnh viễn khỏi hệ thống. Bạn có
														muốn tiếp tục?</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-secondary"
															data-dismiss="modal">Đóng</button>
														<a
															href="/sale/categoryTable/list/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(userItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/sale/categoryTable/list?p=${userItem.number-1}"
