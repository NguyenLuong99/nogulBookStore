												...
												<tr>
													...
													<td
														...
														style="color: #ffffff; text-decoration: none;"><img
															src="https://www.sacvang.com/data/04/mau-logo-chu-n-dep-04.jpg"
															width="27" height="23"
							...
							<table align="center" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td align="center"
										...
										<img
										src="https://img.thuthuatphanmem.vn/uploads/2018/10/13/hinh-anh-cam-on-dep-va-hay_043634267.jpg"
								...
								<tr>
									<td align="left"
										...
										<p
											...
											Thank you for ordering at <b style="color: orange;">NogulBookStore</b>.
											Please check your order information. Any questions please
											contact 0396911849 for support. Thanks!
										</p>
									</td>
								</tr>
								<tr>
									<td align="left" style="padding-top: 20px;">
										<table cellspacing="0" cellpadding="0" border="0" width="100%">
											...
											<c:forEach var="item" items="${listPayment}">
												<tr>
													<td width="75%" align="left"
														...
														${item.order.book.name} (${item.order.quality}) X ${item.totalPrice /item.order.quality}</td>
													<td width="25%" align="right"
														style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding: 5px 10px;">
														<fmt:formatNumber type="number" pattern="###,###,###"
															value="${item.totalPrice}" /> VNĐ
													</td>
												</tr>
											</c:forEach>
										...
										<table border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td align="center" style="border-radius: 5px;"
													bgcolor="#66b3b7"><a href="/my-order" target="_blank"
								...
								<tr>
									<td align="center"
										...
										<p
											...
											Cầu Đặng Sơn, <br> Đô Lương <br>Nghệ An Provide
										</p>
									</td>
								</tr>
								<tr>
