        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form:form  action="/forgot-password" method="post"  id="form-signin" class="form-signin mt-2" modelAttribute="forgotPassword" >
                    	<label >Bạn đã quên mật khẩu!</label>
                    	<label  >Đừng lo, nhập vào email để lấy lại!</label>
                        <div class="form-label-group">
                            <form:input type="email" class="form-control" placeholder="Nhập địa chỉ email"  name="email" path="email"/>
                                 <form:errors path="email" cssClass="error"/>
                        </div>
                        <div class="custom-control custom-checkbox mb-3">
                            <a href="/login" class="float-right text-decoration-none" style="color: #F5A623">Quay lại</a>
                        </div>

                        <button class="btn btn-lg btn-block btn-signin text-uppercase text-white" type="submit"
                            style="background: #F5A623">Quên mật khẩu</button>
                        <hr class="my-4">
