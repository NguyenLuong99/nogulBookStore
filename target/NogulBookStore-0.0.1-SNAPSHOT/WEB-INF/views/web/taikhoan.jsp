                ...
                <div class="account-page-tab-content m-4">
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                          <a class="nav-item nav-link active" id="nav-taikhoan-tab" href="/my-profile" role="tab" aria-controls="nav-home" aria-selected="true">Thông tin tài khoản</a>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active pl-4 " id="nav-taikhoan" role="tabpanel" aria-labelledby="nav-taikhoan-tab">
                            ...
                            <form action="/update/my-profile" modelAttribute="user" method="post">
                            <div class="hoten my-3">
                                <div class="row">
                                    <label class="col-md-2 offset-md-2" for="account-hoten">Họ tên</label>
                                    <input class="col-md-4" type="text" name="fullname" value="${sessionScope.userLogin.username}">
                                </div>
                            </div>
                            <div class="email my-3">
                                <div class="row">
                                    <label class="col-md-2 offset-md-2" for="account-email">Địa chỉ email  </label>
                                    <input class="col-md-4" type="text" name="email"  value="${account.email }">
                                </div>
                            </div>
                            <c:set var="type" scope="session" value="${sessionScope.account.type}" />
                            <c:if test="${type==1 }">
                        ...
                        <div class="tab-pane fade show pl-4 " id="nav-diachi" role="tabpanel" aria-labelledby="nav-diachi-tab">
                            ...
                            <div class="email my-3">
                                <div class="row">
                                    ...
                                    <input class="col-md-4" type="text" name="account-phone"  value="">
                                </div>
                            </div>
                            <div class="email my-3">
                                <div class="row">
                                    <label class="col-md-2 offset-md-2" for="account-address">Địa chỉ liên hệ</label>
                                    <input class="col-md-4" type="text" name="account-address"  value="">
                                </div>
                            </div>
                                <div class="capnhat my-3">
                                    <div class="row">
